	  ...
	  public ArrayList<Message> getMessageBy_roomtype(String roomtype){
	      ...
	      String SQL="select * from message where roomtype=?";
	        try {
	            ...
	            while (resultSet.next()){
	            	Message message = new Message();
	                message.setOrder_id(resultSet.getString("order_id"));
	                message.setCustomer_id(resultSet.getString("customer_id"));
	                message.setName(resultSet.getString("name"));
	                message.setMessage(resultSet.getString("message"));
	                message.setRoom_id(resultSet.getString("room_id"));
	                message.setRoomtype(resultSet.getString("roomtype"));
	                message.setLevel(resultSet.getInt("level"));
	                messageList.add(message);
	            }
	            stmt.close();
	            con.close();

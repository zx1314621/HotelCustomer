...
public class ReceptionistDao extends BaseDao {
    //添加前台
    public boolean addReceptionist(Receptionist receptionist){
        Connection con;
        PreparedStatement stmt;
        String SQL="Insert into Receptionist(receptionist_id,password,name,gender,age) values(?,?,?,?,?);";
        try {

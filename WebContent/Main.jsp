							...
							<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
								<nav class="link-effect-12">
									<ul class="nav navbar-nav w3_agile_nav">
										<li class="active"><a href="Main.jsp"><span>主页</span></a></li>
										<li>
											<c:choose>
    											<c:when test="${sessionScope.c == null}">
													<a href="javascript:void(0);" id="func11" onclick="func11();"><span>登录</span></a>
												</c:when>
												<c:otherwise>
													<p style="font-size:150%;font-family:微软雅黑;color:#CAFFFF;">&nbsp;&nbsp;&nbsp;&nbsp;欢迎您，${sessionScope.c.name}&nbsp;&nbsp;&nbsp;&nbsp;</p>
												</c:otherwise>
											</c:choose>
										</li>
										<li>
											<c:choose>
    											<c:when test="${sessionScope.c == null}">
													<a href="javascript:void(0);" id="func12" onclick="func12();"><span>注册</span></a>
												</c:when>
												<c:otherwise>
													<a href="javascript:void(0);" id="quit" onclick="quit();"><span>注销</span></a>
												</c:otherwise>
											</c:choose>
										</li>
									</ul>	
	...
	<div class="about">
		<div class="container">
			<div class="w3ls-heading">
				...
				<br>
 <table align = center>
        <tr><td><p style="font-size:200%;font-family:微软雅黑">入住日期</p></td><td><p style="font-size:200%;font-family:微软雅黑">退房日期</p></td><td></td></tr>
